...
class Equalizer:
    ...
    def set(self, **options: Unpack[EqualizerOptions]) -> Self:
        ...
        To change specific bands, consider accessing :attr:`~ravelink.Equalizer.payload` first.
        """
        default: dict[int, EqualizerPayload] = {n: {"band": n, "gain": 0.0} for n in range(15)}
...
class Filters:
    ...
    See: :meth:`~ravelink.Filters.reset` to reset **every** individual filter.

    This class is already applied an instantiated on all new :class:`~ravelink.Player`.

    See: :meth:`~ravelink.Player.set_filters` for information on applying this class to your :class:`~ravelink.Player`.
    See: :attr:`~ravelink.Player.filters` for retrieving the applied filters.
    ...
    .. code:: python3
        ...
        filters: ravelink.Filters = ravelink.Filters()
        await player.set_filters(filters)


        # Retrieve the payload of any Filters instance...
        filters: ravelink.Filters = player.filters
        print(filters())
    ...
    def set_filters(self, **filters: Unpack[FiltersOptions]) -> None:
        ...
        To set the filters to the player directly see :meth:`ravelink.Player.set_filters`

        Parameters
        ----------
        volume: float
            The Volume filter to apply to the player.
        equalizer: :class:`ravelink.Equalizer`
            The Equalizer filter to apply to the player.
        karaoke: :class:`ravelink.Karaoke`
            The Karaoke filter to apply to the player.
        timescale: :class:`ravelink.Timescale`
            The Timescale filter to apply to the player.
        tremolo: :class:`ravelink.Tremolo`
            The Tremolo filter to apply to the player.
        vibrato: :class:`ravelink.Vibrato`
            The Vibrato filter to apply to the player.
        rotation: :class:`ravelink.Rotation`
            The Rotation filter to apply to the player.
        distortion: :class:`ravelink.Distortion`
            The Distortion filter to apply to the player.
        channel_mix: :class:`ravelink.ChannelMix`
            The ChannelMix filter to apply to the player.
        low_pass: :class:`ravelink.LowPass`
            The LowPass filter to apply to the player.
        plugin_filters: :class:`ravelink.PluginFilters`
            The extra Plugin Filters to apply to the player. See :class:`~ravelink.PluginFilters` for more details.
        reset: bool
    ...
    def reset(self) -> None:
        ...
        This method will clear all individual filters, and assign the Ravelink default classes.
        """
        self._reset()
    ...
    def equalizer(self) -> Equalizer:
        """Property which returns the :class:`~ravelink.Equalizer` filter associated with this Filters payload."""
        return self._equalizer

    @property
    def karaoke(self) -> Karaoke:
        """Property which returns the :class:`~ravelink.Karaoke` filter associated with this Filters payload."""
        return self._karaoke

    @property
    def timescale(self) -> Timescale:
        """Property which returns the :class:`~ravelink.Timescale` filter associated with this Filters payload."""
        return self._timescale

    @property
    def tremolo(self) -> Tremolo:
        """Property which returns the :class:`~ravelink.Tremolo` filter associated with this Filters payload."""
        return self._tremolo

    @property
    def vibrato(self) -> Vibrato:
        """Property which returns the :class:`~ravelink.Vibrato` filter associated with this Filters payload."""
        return self._vibrato

    @property
    def rotation(self) -> Rotation:
        """Property which returns the :class:`~ravelink.Rotation` filter associated with this Filters payload."""
        return self._rotation

    @property
    def distortion(self) -> Distortion:
        """Property which returns the :class:`~ravelink.Distortion` filter associated with this Filters payload."""
        return self._distortion

    @property
    def channel_mix(self) -> ChannelMix:
        """Property which returns the :class:`~ravelink.ChannelMix` filter associated with this Filters payload."""
        return self._channel_mix

    @property
    def low_pass(self) -> LowPass:
        """Property which returns the :class:`~ravelink.LowPass` filter associated with this Filters payload."""
        return self._low_pass

    @property
    def plugin_filters(self) -> PluginFilters:
        """Property which returns the :class:`~ravelink.PluginFilters` filters associated with this Filters payload."""
